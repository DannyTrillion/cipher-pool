...
export function WalletView() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="card p-5 sm:p-6">
          ...
          <div className="mt-4 grid grid-cols-2 overflow-hidden rounded-2xl border border-line bg-black/20 [&>*:nth-child(odd)]:border-r [&>*:nth-child(-n+2)]:border-b [&>*]:border-line">
            {[
              ...
              { l: "cUSDT in wallet", v: user?.walletBalance ? walletBal : null, h: user?.walletBalance ?? null, c: TOKEN.address, k: "wallet", tone: "bg-cipher" },
          ...
          <div className="mt-3 flex items-center justify-between rounded-xl border border-line bg-black/20 px-4 py-3">
            <div className="text-[12px] text-ink-muted">USDT in wallet <span className="ml-1 rounded-full border border-line px-1.5 text-[9px] uppercase tracking-wider text-ink-faint">public</span></div>
        ...
        <div className="card p-5 sm:p-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            {[
              ...
              { l: "Wrap", d: "USDT → cUSDT", href: "/#wrap" },
              { l: "Unwrap", d: "cUSDT → USDT", href: "/#unwrap" },
            ].map((a) => (
      ...
      <div className="text-[11px] text-ink-faint">Contracts: <a className="hover:text-ink" href={etherscanAddr(POOL.address)} target="_blank" rel="noreferrer">pool</a> · <a className="hover:text-ink" href={etherscanAddr(TOKEN.address)} target="_blank" rel="noreferrer">cUSDT</a> · <a className="hover:text-ink" href={etherscanAddr(TUSD.address)} target="_blank" rel="noreferrer">USDT</a></div>
    </div>
  );
}
