...
export const BANK: Entry[] = [
  ...
  { id: "unwrap", q: "How do I get my tUSD back?", keys: ["unwrap", "unshield", "back to tusd", "tusd back", "convert back", "original", "erc-20", "erc20"], a: "Use the Unwrap tab in the Play section. It turns private cUSD back into public tUSD, one for one. It takes two confirmations with a short wait in between while the network confirms the amount.", follow: ["Take my money out"] },
