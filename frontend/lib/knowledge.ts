...
Think of a piggy bank shared by a group. Everyone puts money in and keeps it. The bank earns interest on the whole pile, and instead of splitting that interest evenly, the group holds a draw every 5 minutes and gives it to a few winners. Nobody ever loses what they put in.
...
export const SUGGESTED = ["What is this?", "Can I lose money?", "How do I start?", "How are winners picked?", "What can other people see?", "What is USDT and cUSDT?"];

export const BANK: Entry[] = [
  { id: "what", q: "What is this?", keys: ["what", "this", "about", "pool", "cipher", "explain", "site", "app"], a: "A shared savings pool. Everyone puts money in and keeps it. The interest the pool earns is given out as prizes in a draw every 5 minutes. Your money is scrambled on the blockchain, so nobody can see how much you saved.", follow: ["Can I lose money?", "How do I start?"] },
  ...
  { id: "start", q: "How do I start?", keys: ["start", "begin", "how", "first", "steps", "new", "guide"], a: "Connect a wallet, get free test USDT from the faucet, wrap it into private cUSDT, then put some in the pool. The Play section has a New here mode that walks you through each step.", follow: ["What is a wallet?", "What is USDT and cUSDT?"] },
  { id: "winners", q: "How are winners picked?", keys: ["winner", "winners", "picked", "chosen", "draw", "random", "lottery", "raffle", "select"], a: "Every 5 minutes the pool draws random numbers, one per prize. It goes through everyone's scrambled balances and picks winners without unscrambling anything. The more you saved, the better your odds. Nobody, not even the pool, learns who won.", follow: ["What are my odds?", "How do I know it was fair?"] },
  ...
  { id: "tokens", q: "What is USDT and cUSDT?", keys: ["tusd", "cusd", "token", "tokens", "wrap", "wrapping", "shield", "dollar", "money"], a: "USDT is free test money, a plain token anyone can see. cUSDT is the same money wrapped so the amounts are scrambled. You wrap USDT into cUSDT one for one, then put cUSDT into the pool. You can unwrap later.", follow: ["How do I get test money?", "How do I start?"] },
  { id: "faucet", q: "How do I get test money?", keys: ["faucet", "free", "test", "get", "mint", "money", "1000", "tusd"], a: "Press Need test USDT in the Play section, or step 2 of New here mode. You get 1,000 test USDT from Zama's official Sepolia mock. It has no real value.", follow: ["What is USDT and cUSDT?"] },
  { id: "wallet", q: "What is a wallet?", keys: ["wallet", "metamask", "connect", "login", "account", "sign"], a: "A wallet is a small browser app, like MetaMask or Rabby, that holds your keys. Here it is your login and the only thing that can read your own numbers. Press Connect in the top right. If you do not have one, the button links to a download page.", follow: ["How do I start?"] },
  ...
  { id: "collect", q: "How do I collect a prize?", keys: ["collect", "claim", "prize", "withdraw prize", "get prize", "payout"], a: "Press Collect prize. It moves your prize to your wallet as cUSDT. Anyone can press it, even with nothing to collect, so pressing it never gives away who won.", follow: ["How do I know if I won?"] },
  { id: "withdraw", q: "Take my money out", keys: ["withdraw", "take out", "cash out", "exit", "leave", "remove", "get my money"], a: "Use the Withdraw tab in the Play section, any time the pool is open. Your money comes back to your wallet as cUSDT. If a draw is running, wait a minute or two until it finishes.", follow: ["Can I lose money?"] },
  { id: "unwrap", q: "How do I get my USDT back?", keys: ["unwrap", "unshield", "back to tusd", "tusd back", "convert back", "original", "erc-20", "erc20"], a: "Use the Unwrap tab in the Play section. It turns private cUSDT back into public USDT, one for one. It takes two confirmations with a short wait in between while the network confirms the amount.", follow: ["Take my money out"] },
  { id: "draw", q: "When is the next draw?", keys: ["when", "next", "draw", "time", "countdown", "schedule", "often", "minutes"], a: "Every 5 minutes on this test network. The big yellow button shows the countdown. When it reaches zero anyone can hold the button to run the draw.", follow: ["Who runs the draw?"] },
  ...
  { id: "prize", q: "Where does the prize come from?", keys: ["prize", "interest", "yield", "where", "come from", "funded", "money from", "apy"], a: "From interest on the pool's money. On this test network the interest is simulated as a steady drip, about 9 cUSDT an hour, and anyone can also add to the prize. In a real deployment it would come from lending the pool's money out.", follow: ["How is the prize split?"] },
  ...
  { id: "unlock", q: "Why do I have to sign to decrypt my numbers?", keys: ["sign", "signature", "decrypt my numbers", "unlock", "see my", "decrypt", "why sign"], a: "Your numbers are encrypted on the blockchain. One signature proves to Zama's relayer that you are the owner, so it decrypts them for you only. You sign once per session.", follow: ["What is scrambled?"] },
  ...
  { id: "ledger", q: "What is the list of accounts at the bottom?", keys: ["list", "ledger", "accounts", "patterns", "bars", "try to decrypt", "try to read"], a: "Those are the real accounts in the pool. Each pattern is drawn from a scrambled balance. Press one and try to decrypt it. Zama's relayer refuses, because only the owner is allowed.", follow: ["What can other people see?"] },
