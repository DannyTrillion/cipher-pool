...
export const SUGGESTED = ["What is this?", "Can I lose money?", "How do I start?", "How are winners picked?", "What can other people see?", "What is tUSDC and cUSDC?"];
...
export const BANK: Entry[] = [
  ...
  { id: "start", q: "How do I start?", keys: ["start", "begin", "how", "first", "steps", "new", "guide"], a: "Connect a wallet, get free test tUSDC from the faucet, wrap it into private cUSDC, then put some in the pool. The Play section has a New here mode that walks you through each step.", follow: ["What is a wallet?", "What is tUSDC and cUSDC?"] },
  ...
  { id: "tokens", q: "What is tUSDC and cUSDC?", keys: ["tusd", "cusd", "token", "tokens", "wrap", "wrapping", "shield", "dollar", "money"], a: "tUSDC is free test money, a plain token anyone can see. cUSDC is the same money wrapped so the amounts are scrambled. You wrap tUSDC into cUSDC one for one, then put cUSDC into the pool. You can unwrap later.", follow: ["How do I get test money?", "How do I start?"] },
  { id: "faucet", q: "How do I get test money?", keys: ["faucet", "free", "test", "get", "mint", "money", "1000", "tusd"], a: "Press Need test tUSDC in the Play section, or step 2 of New here mode. You get 1,000 tUSDC, once per hour per wallet. It has no real value.", follow: ["What is tUSDC and cUSDC?"] },
  ...
  { id: "collect", q: "How do I collect a prize?", keys: ["collect", "claim", "prize", "withdraw prize", "get prize", "payout"], a: "Press Collect prize. It moves your prize to your wallet as cUSDC. Anyone can press it, even with nothing to collect, so pressing it never gives away who won.", follow: ["How do I know if I won?"] },
  { id: "withdraw", q: "Take my money out", keys: ["withdraw", "take out", "cash out", "exit", "leave", "remove", "get my money"], a: "Use the Withdraw tab in the Play section, any time the pool is open. Your money comes back to your wallet as cUSDC. If a draw is running, wait a minute or two until it finishes.", follow: ["Can I lose money?"] },
  { id: "unwrap", q: "How do I get my tUSDC back?", keys: ["unwrap", "unshield", "back to tusd", "tusd back", "convert back", "original", "erc-20", "erc20"], a: "Use the Unwrap tab in the Play section. It turns private cUSDC back into public tUSDC, one for one. It takes two confirmations with a short wait in between while the network confirms the amount.", follow: ["Take my money out"] },
  ...
  { id: "prize", q: "Where does the prize come from?", keys: ["prize", "interest", "yield", "where", "come from", "funded", "money from", "apy"], a: "From interest on the pool's money. On this test network the interest is simulated as a steady drip, about 9 cUSDC an hour, and anyone can also add to the prize. In a real deployment it would come from lending the pool's money out.", follow: ["How is the prize split?"] },
